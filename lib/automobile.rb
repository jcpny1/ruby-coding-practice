class Automobile < Vehicle  # describes a Vehicle type of Automobile
  ...
  def self.scrape_results_page(results_url, results_url_file, results_doc)
    AutoScraper.scrape_results_page(results_url, results_url_file, results_doc, self)
  end
  ...
  def self.scrape_results_detail_page(detail_doc, item_condition, detail_values)
    AutoScraper.scrape_results_detail_page(detail_doc, item_condition, detail_values)
  end
